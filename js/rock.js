...
//public methods
  ...
  p.init = function(rock_shape, q){
    ...
    this.label = new createjs.Text(q.text, "bold 20px Inter, 'Noto Sans SC', sans-serif", "#FFFFFF");
    ...
    this.label.shadow = new createjs.Shadow("#000000", 2, 2, 3);
  ...
  p.freeze = function(rock_shape){
    ...
    this.label.color = "#E0E0E0";
    this.label.text = this.question.lshk;
    this.label.maxWidth = 80;
    this.label.shadow = new createjs.Shadow("#000000", 1, 1, 2);
    this.addChild(this.label);    
  };
