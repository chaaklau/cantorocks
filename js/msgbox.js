...
//public methods
  ...
  p.init = function(title, message){
    ...
    this.title_label = new createjs.Text(this.title, "bold 20px Inter, 'Noto Sans SC', sans-serif", "#FFFFAA");
    ...
    this.message_label = new createjs.Text(this.message, "14px Inter, 'Noto Sans SC', sans-serif", "#FFFFFF");
